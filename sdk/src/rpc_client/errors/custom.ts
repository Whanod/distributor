...
export class ClawbackDuringVesting extends Error {
  static readonly code = 6007
  readonly code = 6007
  readonly name = "ClawbackDuringVesting"
  readonly msg = "Clawback cannot be before vesting ends"

  constructor(readonly logs?: string[]) {
    super("6007: Clawback cannot be before vesting ends")
  }
}
...
export class ClaimingIsNotStarted extends Error {
  static readonly code = 6018
  readonly code = 6018
  readonly name = "ClaimingIsNotStarted"
  readonly msg = "Claiming is not started"

  constructor(readonly logs?: string[]) {
    super("6018: Claiming is not started")
  }
}

export class CannotCloseDistributor extends Error {
  static readonly code = 6019
  readonly code = 6019
  readonly name = "CannotCloseDistributor"
  readonly msg = "Cannot close distributor"

  constructor(readonly logs?: string[]) {
    super("6019: Cannot close distributor")
  }
}

export class CannotCloseClaimStatus extends Error {
  static readonly code = 6020
  readonly code = 6020
  readonly name = "CannotCloseClaimStatus"
  readonly msg = "Cannot close claim status"

  constructor(readonly logs?: string[]) {
    super("6020: Cannot close claim status")
  }
}
...
export function fromCode(code: number, logs?: string[]): CustomError | null {
  switch (code) {
    ...
    case 6007:
      return new ClawbackDuringVesting(logs)
    case 6008:
    ...
    case 6018:
      return new ClaimingIsNotStarted(logs)
    case 6019:
      return new CannotCloseDistributor(logs)
    case 6020:
      return new CannotCloseClaimStatus(logs)
  }
